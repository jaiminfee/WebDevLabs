...
async function initMap() {
 ...
 const position = { lat: 40.44562, lng:-79.94334 };
...
L1.forEach(element => {
 ...
 function greetingFunc() {
    ...
    if (h>=5 && h<12) {
        ...
        E.innerHTML=" Good morning, I am Jaimin";
 
    } else if (h>=12 && h<18) {
 
        E.innerHTML+=" Good afternoon, I am Jaimin";
 
    } else if (h>=18 && h<20) {
 
        E.innerHTML=" Good evening, I am Jaimin";
 
    } else  {
 
        E.innerHTML="Good night, I am Jaimin";
